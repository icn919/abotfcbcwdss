...
//Update User basic info
  if(isset($_POST['update'])) {
    $req_fields = array('name','phonenumber','email','username','level');
    ...
    if(empty($errors)){
       ...
       $status   = remove_junk($db->escape($_POST['status']));
            $sql = "UPDATE users SET name ='{$name}', phonenumber = '{$phonenumber}',email = '{$email}',username ='{$username}',user_level='{$level}',status='{$status}' WHERE id='{$db->escape($id)}'";
         $result = $db->query($sql);
       ...
       <div class="panel-body">
          <form method="post" action="edit_user.php?id=<?php echo (int)$e_user['id'];?>" class="clearfix">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="phonenumber" placeholder="Phonenumber" value="<?php echo remove_junk(ucwords($e_user['phonenumber'])); ?>">
            </div>
            <div class="form-group">
                <label for="name">Email</label>
                <input type="text" class="form-control" name="email" placeholder="Email" value="<?php echo remove_junk(lcfirst($e_user['email'])); ?>" readonly>
            </div>
            <div class="form-group">
                  <label for="username" class="control-label">Username</label>
                  <input type="text" class="form-control" name="username" value="<?php echo remove_junk(ucwords($e_user['username'])); ?>" readonly>
            </div>
            <div class="form-group">
